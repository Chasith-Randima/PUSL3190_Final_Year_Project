...
def auto():
    print("bart route called")
    # Get the content from the request  title,author,date,time,image
    content = request.json.get('content', '')
    ...
    # if request.json.get('customFetch'):
    #     customFetch = request.json.get('customFetch','')
    # print(content)
    ...
    summary_document = {
        ...
        "url":url
        # "customFetch":customFetch if customFetch else "false"
